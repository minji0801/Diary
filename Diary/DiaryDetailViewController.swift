...
class DiaryDetailViewController: UIViewController {
    ...
    private func dateToString(date: Date) -> String {
        ...
        fomatter.dateFormat = "yy년 MM월 dd일(EEEEE)"
    ...
    @objc func tapStarButton() {
        ...
        self.diary?.isStar = !isStar
        NotificationCenter.default.post(name: NSNotification.Name("starDiary"), object: ["diary": self.diary, "isStar": self.diary?.isStar ?? false, "uuidString": diary?.uuidString], userInfo: nil)
    }
